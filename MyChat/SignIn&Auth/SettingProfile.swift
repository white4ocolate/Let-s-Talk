...
//  MyChat
//
//  Created by white4ocolate on 04.06.2024.
//
import UIKit
import FirebaseAuth
import SDWebImage

class SettingProfile: UIViewController {
    ...
    init(currentUser: MyUser) {
        ...
        photoImageView.circleImageView.sd_setImage(with: URL(string: currentUser.avatarStringURL))
    }
...
extension SettingProfile: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
